// Ant Design Outlined icon paths (viewBox 64 64 896 896) — same glyphs as the contact page.
const MAIL_OUTLINED_PATH =
...
export const RESUME_PDF_CONTACT_ICON_PATHS = {
  mail: MAIL_OUTLINED_PATH,
  github: GITHUB_OUTLINED_PATH,
